...
def main():
    ...
    Infinity1=Obstacles(((797, 859), (673, 958), (638, 979), (561, 977), (588, 913), (800, 811)))
    Infinity2=Obstacles(((303, 971), (299, 927), (312, 876), (398, 859), (532, 899), (546, 949), (507, 976)))
    Infinity3=Obstacles(((163, 885), (287, 860), (264, 965)))
    Infinity4=Obstacles(((761, 737), (713, 809), (559, 806), (528, 764)))
    Infinity5=Obstacles(((761, 737), (771, 662), (645, 600), (715, 742)))
    Infinity6=Obstacles(((645, 600), (667, 646), (571, 726), (508, 732), (539, 621)))
    Infinity7=Obstacles(((721, 357), (635, 465), (532, 486), (534, 372), (690, 290)))
    Infinity8=Obstacles(((820, 466), (743, 364), (742, 196), (820, 112)))
    Infinity9=Obstacles(((731, 551), (723, 535), (689, 555), (702, 569)))
    Infinity10=Obstacles(((491, 302), (336, 398), (431, 409), (506, 344)))
    Infinity11=Obstacles(((336, 398), (395, 362), (356, 193), (310, 327)))
    Infinity12=Obstacles(((435, 582), (390, 491), (289, 645), (311, 732)))
    Infinity13=Obstacles(((363, 534), (390, 491), (314, 426), (216, 425)))
    Infinity14=Obstacles(((216, 425), (270, 464), (204, 504)))
    Infinity15=Obstacles((((216, 425), (128, 513), (118, 589), (158, 663), (186, 644))))
    Infinity16=Obstacles(((254, 624), (202, 672), (269, 709)))
    Infinity17=Obstacles(((317, 105), (236, 257), (151, 300), (128, 241), (228, 67)))
    Infinity18=Obstacles(((281, 65), (275, 0), (337, 0)))
    Infinity19=Obstacles(((381, 150), (349, 146), (412, 0), (471, 0)))
    
    Rough1=Obstacles(((697,0),(687,164),(604,233),(520,214),(487,113),(520,0)),Roughness=4)
    Rough2=Obstacles(((800, 811), (676, 867), (761, 737)),Roughness=1.2)
    Rough3=Obstacles(((676, 867), (575, 911), (498, 832), (559, 806), (713, 809)),Roughness=1.2)
    Rough4=Obstacles(((498, 832), (559, 806), (508, 732), (454, 760)),Roughness=1.2)
    Rough5=Obstacles(((436, 836), (315, 875), (351, 829), (433, 789)),Roughness=1.5)
    Rough6=Obstacles(((351, 784), (287, 860), (230, 872), (144, 822), (197, 697)),Roughness=2)
    Rough7=Obstacles(((197, 697), (144, 822), (11, 757), (11, 597)),Roughness=2)
    Rough8=Obstacles(((144, 822), (123, 859), (34, 871), (29, 831), (74, 789)),Roughness=6)
    Rough9=Obstacles(((11, 469), (75, 192), (11, 0)),Roughness=2.5)
    Rough10=Obstacles(((731, 551), (723, 535), (820, 465), (820, 640)),Roughness=1.3)
