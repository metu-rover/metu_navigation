...
#burayı yapmaktan emin değlim ama ekranın şeklini korumak mantıklı olsa da hiç visual kullanmadan yapmak daha mantıklı olduğu için ekran şeklini siktir edip
#direkt harita ölçüsünün roverın kısa kenarının ölçüsne bölerek elde edeceğimiz oran ile de haraket sağlayabiliriz.
#böylelikle hem pixel başına daha büyük cm ilerletirken daha keskin dönüşleri daha güzel izleyebiliriz.
#Ancak haritanın şekli ile tanımlanan şekilin oranları aynı olmalı.Yani çok dikey bir harita gelirse maksimum 1080 pixel alınmalı veya harita yan çevrilmeli
